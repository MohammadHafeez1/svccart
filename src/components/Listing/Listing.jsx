...
const allProducts = [
  { id: 1, name: "SVC L-Shaped Sofa", description: "Comfortable L-shaped sofa perfect for corner spaces.", discount: "-15%", image: lsofa, reviews: 10, originalPrice: "₹63,529.41", discountedPrice: "₹54,000", category: "furniture" },
  { id: 2, name: "SVC U-Shaped Luxury Sofa", description: "Spacious U-shaped sofa with plush cushions.", discount: "-20%", image: usofa, reviews: 8, originalPrice: "₹1,37,500.00", discountedPrice: "₹1,10,000", category: "furniture" },
  { id: 3, name: "SVC 3-Seater Fabric Sofa", description: "Stylish and cozy 3-seater fabric sofa.", discount: "-10%", image: threesofa, reviews: 15, originalPrice: "₹32,221.11", discountedPrice: "₹28,999", category: "furniture" },
  { id: 4, name: "SVC Sofa Set (5 Piece)", description: "Complete 5-piece sofa set with modern design.", discount: "-18%", image: setsofa, reviews: 12, originalPrice: "₹91,463.41", discountedPrice: "₹74,999", category: "furniture" },
  { id: 5, name: "SVC Wooden Dining Table Set", description: "Elegant 6-seater dining table with chairs.", discount: "-12%", image: diningtable, reviews: 5, originalPrice: "₹45,453.41", discountedPrice: "₹39,999", category: "furniture" },
  { id: 6, name: "SVC Premium Wardrobe", description: "Spacious wardrobe with shelves and mirror.", discount: "-10%", image: wardrobe, reviews: 9, originalPrice: "₹48,887.78", discountedPrice: "₹43,999", category: "furniture" },
  { id: 7, name: "SVC King Size Bed", description: "Luxury king-size bed with strong wooden frame.", discount: "-14%", image: bed, reviews: 7, originalPrice: "₹37,209.30", discountedPrice: "₹32,000", category: "furniture" },
  { id: 8, name: "SVC Multi-Storage Cupboard", description: "Compact cupboard with multiple storage sections.", discount: "-10%", image: cupboard, reviews: 4, originalPrice: "₹16,665.56", discountedPrice: "₹14,999", category: "furniture" },
  ...
  { id: 12, name: "SVC Convection Microwave Oven", description: "Multi-function convection microwave for quick meals.", discount: "-12%", image: oven, reviews: 6, originalPrice: "₹12,000.00", discountedPrice: "₹10,560", category: "home-appliances" },
  { id: 13, name: "SVC 32\" Smart TV - Full HD", description: "Smart TV with HD display and built-in streaming.", discount: "-40%", image: smarttv, reviews: 1, originalPrice: "₹44,998.33", discountedPrice: "₹26,999", category: "electronics" },
  { id: 14, name: "SVC 40\" LED TV - 4K Ultra HD", description: "Crisp 4K UHD display with vibrant colors.", discount: "-35%", image: ledtv, reviews: 5, originalPrice: "₹59,998.46", discountedPrice: "₹38,999", category: "electronics" },
  ...
  { id: 23, name: "Kitchen Cooking Combo – Pans & Pots Set", description: "Complete set of kitchen essentials for everyday use.", discount: "-30%", image: cookware, reviews: 10, originalPrice: "₹12,000.00", discountedPrice: "₹8,400", category: "home-appliances" },
  { id: 24, name: "Nonstick Cookware Combo Set", description: "Nonstick pans and pots combo – easy cooking and cleaning.", discount: "-26%", image: nonstick, reviews: 7, originalPrice: "₹4,729.73", discountedPrice: "₹3,500", category: "home-appliances" },
];
